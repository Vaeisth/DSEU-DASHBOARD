...
const fetchAllEmployees = async () => {
  const { data } = await apiRequestAxios({ 
    url: "http://134.209.144.96:8081/superadmin/all-users", 
    method: 'GET' 
  });
  return data.data;
};
  ...
  if (isError) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="text-center p-8 bg-white rounded-xl shadow-sm max-w-md">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">Failed to Load Employees</h3>
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-4">
                  <img
                    src={employee.picture || "https://via.placeholder.com/100"}
                    alt={employee.name}
